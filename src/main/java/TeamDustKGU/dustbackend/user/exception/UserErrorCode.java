...
public enum UserErrorCode implements ErrorCode {
    ...
    UPDATE_AFTER_30_DAYS(HttpStatus.CONFLICT, "USER_006", "마지막 수정시간으로부터 30일 후에 변경할 수 있습니다."),
    ...
    INVALID_PASSWORD_FORMAT(HttpStatus.BAD_REQUEST, "USER_014", "비밀번호 형식이 올바르지 않습니다."),
    ;
